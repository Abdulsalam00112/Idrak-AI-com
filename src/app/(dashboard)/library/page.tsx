...
const SAVED_ITEMS = [
  { type: 'question', title: 'If x² − 5x + 6 = 0, find the values of x', subject: 'Mathematics', topic: 'Algebra', savedAt: '2 days ago' },
  { type: 'question', title: 'Explain the difference between mitosis and meiosis', subject: 'Biology', topic: 'Cell Biology', savedAt: '3 days ago' },
  { type: 'explanation', title: 'Why negative times negative gives positive', subject: 'Mathematics', topic: 'Numbers', savedAt: '5 days ago' },
  { type: 'conversation', title: 'Understanding quadratic equations step by step', subject: 'Mathematics', topic: 'Algebra', savedAt: '1 week ago' },
  { type: 'question', title: 'A car accelerates uniformly from rest at 4 m/s² for 10 s. Find final velocity.', subject: 'Physics', topic: 'Mechanics', savedAt: '1 week ago' },
];
