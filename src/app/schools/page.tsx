        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <Card padding="lg" tone="navy">
              ...
              <Button variant="coral" size="sm" fullWidth className="mt-5">Manage licenses</Button>
            </Card>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="dark" size="lg" icon={Mail}>Talk to us</Button>
              </div>
          ...
          <Card padding="xl" className="bg-navy text-white">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Button variant="white" size="lg" className="text-navy">Learn more</Button>
              </div>
            </div>
          </Card>
        </div>
