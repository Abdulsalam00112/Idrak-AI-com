    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="coral" size="sm" icon={Plus}>Add content</Button>
        </div>
      </div>

      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <StatCard value="12,480" label="Total users" sublabel="+18% this month" tone="coral" icon={Users} />
        <StatCard value="₦2.4M" label="Revenue (MTD)" sublabel="+28% MoM" tone="lavender" icon={DollarSign} />
        <StatCard value="45,420" label="Questions in bank" sublabel="+340 this week" tone="yellow" icon={FileQuestion} />
        <StatCard value="87%" label="Retention" sublabel="30-day active" tone="mint" icon={TrendingUp} />
      </div>
