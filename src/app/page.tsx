              ...
              <Card key={exam.id} padding="lg" hoverable className={cn(
                ...
                <div className="flex items-center justify-between pt-4 border-t border-line/70">
                  <div className="text-sm">
                    <span className="font-black text-navy">{exam.totalQuestions.toLocaleString()}</span>
                    <span className="text-ink-mute ml-1.5">questions</span>
                  </div>
      ...
      <section className="py-20 md:py-28 bg-lavender-light/40 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            description="Idrak doesn't just give you thousands of questions. It understands how exams work and how you learn — then gives you the exact next thing you should study."
          />
                ...
                <div className="relative">
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-white/10 rounded-2xl p-4">
                      <div className="text-3xl font-black text-coral">1,248</div>
                      <div className="text-sm text-white/70">Active students</div>
                    </div>
                    <div className="bg-white/10 rounded-2xl p-4">
                      <div className="text-3xl font-black text-yellow">87%</div>
                      <div className="text-sm text-white/70">Avg accuracy</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-white/10">
                    ...
                    <div className="text-sm text-white/70">+ 1,244 more students preparing now</div>
                  </div>
                </div>
              </Card>
            </div>
